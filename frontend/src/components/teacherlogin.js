...
const TeacherLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate('/components/teacherdashboard');
    };
    return (
        <div style={styles.container}>
            ...
            <div style={styles.contentContainer}>
                <div style={styles.instructionContainer}>
                    <h2>Instructions</h2>
                    <p>Welcome to the teacher login portal. Please follow the steps below:</p>
                    <ul>
                        <li>Enter your registered email address and password.</li>
                        <li>Ensure your password matches the confirmation field.</li>
                        <li>If you don’t have a login, contact your administration.</li>
                        <li>Once logged in, you can manage classes and view results.</li>
